...
After two hours of compile error hunting because you forgot to rename a
...
Succeeding in all this points we should get a mark of 4.5.
...
function signature.
 ...
 \item If the type can not be determined, a comment is inserted into the block.
\end{itemize}
