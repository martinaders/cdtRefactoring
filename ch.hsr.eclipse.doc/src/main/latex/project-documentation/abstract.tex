...
\texttt{function(int param1)} from listing \ref{togglefourth} gets toggled
...
Method} (Wrongly named with the Java terminology method, and not function) does
...
He comes to the point where he would write it's first declaration. He uses a
keystroke and the declaration is replaced with a definition containing a
appropriated return statement.
