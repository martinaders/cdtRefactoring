...
\begin{lstlisting}[caption={A.cpp},label={twofilesolution_implem},language=C++]
#include "A.h"
...
position from listing \ref{01toggleMemberFunction} is reached. An
empty namespace in an implementation file will be removed.
