...
\lstinputlisting[caption={A.h},label={01freefuncPre}]{01freefuncPre.cpp}
...
\lstinputlisting[caption={A.h},label={01freefuncPostCpp}]{01freefuncPost.cpp}
& & 
\lstinputlisting[caption={A.cpp},label={01freefuncPostH}]{01freefuncPost.h}
\end{tabular}
...
If the moved function definition is contained in a namespace definition, the
namespace definition will be created. Then the function is inserted in the newly
created namespace definition.
On the other hand, empty namespace definitions shall be deleted when toggling
removed the last function contained within.
