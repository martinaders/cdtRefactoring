...
The new plug-in differs from existing plug-ins by minimizing in the way that it
minimizes human interaction by providing a single keystroke interface. The
