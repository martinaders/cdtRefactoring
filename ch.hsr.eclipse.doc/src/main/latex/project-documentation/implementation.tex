...
With the help of these three strategies, member functions may be toggled 
circularly.
...
about definition, declaration and their translation units. Further it stores
this information.
...
common refactoring for this problem is to introduce a parameter object which 
consolidates all arguments.
...
%TODO: Martin, can you add some words about the things you did, runner,
% delegate, and so on...
...
28mm,clip,scale=0.8]{seqdiagram/seqdiagram.pdf} %,clip,
