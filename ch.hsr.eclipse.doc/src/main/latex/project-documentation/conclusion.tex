...
\textbf{Cause}: Unknown. It seems to be a offset bug and/or a rewriter bug.
...
\textbf{Solution}: No solution yet. This would be solve by a new rewriter.
...
extremly time consuming to find workarounds for such problems.
