...
The goal was to develop a plug-in that is used by the world an not thrown away.
...
kept in mind to continue this. This led to the fact that the documentation 

Chapters like specification should be written early. The wiki is not read but
the documentation is read and if written early mistakes do not life long as long
as the documentation is read several times.
